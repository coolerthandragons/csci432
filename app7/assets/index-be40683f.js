...
function requireFetchNpmBrowserify() {
  if (hasRequiredFetchNpmBrowserify)
...
const _hoisted_1$2 = { class: "slideshow" };
const _hoisted_2$2 = { class: "photo" };
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    let index = 0;
    const client = c("b2MHchcEWT80INa4M2ULnTbWF0l1M60oyZBN3vXRQp110rtXJjWqqQH7");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", _hoisted_2$2, [
          ...
          createBaseVNode("h3", null, toDisplayString(photo.title), 1),
          _hoisted_4$1,
          createBaseVNode("a", {
            href: photo.photographer_url,
            target: "_blank"
          }, toDisplayString(photo.photographer), 9, _hoisted_5$1)
        ]),
        createBaseVNode("button", {
          class: "prev",
          onClick: _cache[0] || (_cache[0] = ($event) => prevImage()),
          disabled: unref(index) == 0 ? true : false
        }, "Previous", 8, _hoisted_6$1),
        createBaseVNode("button", {
          class: "next",
          onClick: _cache[1] || (_cache[1] = ($event) => nextImage()),
          disabled: unref(index) == 7 ? true : false
        }, "Next", 8, _hoisted_7$1)
      ]);
    };
  }
};
const Slideshow1_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$1 = { class: "slideshow" };
const _hoisted_2$1 = { class: "photo" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const photoArray = [
      ...
      {
        src: "/dragon_lights.jpg",
        name: "Dragon Lights",
        photographer: "Eva Bronzini",
        photographer_url: "https://www.pexels.com/@eva-bronzini/"
      },
      {
        src: "/dragon_cuties.jpg",
        name: "Dragon Cuties",
        photographer: "Sebastiaan Stam",
        photographer_url: "https://www.pexels.com/@sebastiaan9977/"
      },
      {
        src: "/dragon_statue.jpg",
        name: "Dragon Statue",
        photographer: "Suraphat Nuea-on",
        photographer_url: "https://www.pexels.com/@suraphat/"
      },
      {
        src: "/dragon_fire.jpg",
        name: "Dragon Fire",
        photographer: "Сергей Христинич",
        photographer_url: "https://www.pexels.com/@82664875/"
      },
      {
        src: "/dragon_love.jpg",
        name: "Dragon Love",
        photographer: "Pavel Georgiev",
        photographer_url: "https://www.pexels.com/@pavel-georgiev-941244/"
      },
      {
        src: "/dragon_incense.jpg",
        name: "Dragon Incense",
        photographer: "Rachel Claire",
        photographer_url: "https://www.pexels.com/@rachel-claire/"
      },
      {
        src: "/dragon_on_bank.jpg",
        name: "Dragon On Bank",
    ...
    function loadImage1() {
      photo1.title = photoArray[index1].name;
      photo1.photographer = photoArray[index1].photographer;
      photo1.photographer_url = photoArray[index1].photographer_url;
      photo1.url = photoArray[index1].src;
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("h3", null, toDisplayString(photo1.title), 1),
          _hoisted_4,
          createBaseVNode("a", {
            href: photo1.photographer_url,
            target: "_blank"
          }, toDisplayString(photo1.photographer), 9, _hoisted_5)
        ]),
        createBaseVNode("button", {
          class: "prev",
          onClick: _cache[0] || (_cache[0] = ($event) => prevImage1()),
          disabled: unref(index1) == 0 ? true : false
        }, "Previous", 8, _hoisted_6),
        createBaseVNode("button", {
          class: "next",
          onClick: _cache[1] || (_cache[1] = ($event) => nextImage1()),
          disabled: unref(index1) == 7 ? true : false
        }, "Next", 8, _hoisted_7)
      ]);
    };
  }
...
const _sfc_main = {
  components: {
    Slideshow: _sfc_main$2,
    Slideshow1: _sfc_main$1
  }
};
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("p", null, "The below works, you have to click on the next button for it to load properly. Once you do that, the previous image loads as well.", -1);
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Slideshow = resolveComponent("Slideshow");
  const _component_Slideshow1 = resolveComponent("Slideshow1");
  return openBlock(), createElementBlock(Fragment, null, [
    createVNode(_component_Slideshow),
    _hoisted_1,
    _hoisted_2,
    createVNode(_component_Slideshow1)
  ], 64);
}
