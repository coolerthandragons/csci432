  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(RouterLink), { to: "/index.html" }, {
          default: withCtx(() => [
            createTextVNode("Home ")
          ]),
          _: 1
        }),
        createVNode(unref(RouterLink), { to: "/edit" }, {
          default: withCtx(() => [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("main", null, [
          createBaseVNode("h3", null, "Welcome, " + toDisplayString(unref(store).firstName) + "! ", 1),
          createBaseVNode("p", null, "User: " + toDisplayString(unref(store).firstName) + " " + toDisplayString(unref(store).lastName), 1),
          createBaseVNode("p", null, "Street: " + toDisplayString(unref(store).street), 1),
          createBaseVNode("p", null, "City: " + toDisplayString(unref(store).city), 1),
          createBaseVNode("p", null, "State: " + toDisplayString(unref(store).state), 1),
          createBaseVNode("p", null, "Zip: " + toDisplayString(unref(store).zip), 1)
        ])
      ], 64);
    };
  }
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("label", { for: "firstName lastName" }, "Name ", -1);
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("label", { id: "address" }, " Address ", -1);
const _sfc_main = {
  __name: "EditView",
  setup(__props) {
    const store = useUserStore();
    function submit() {
      ...
      let zip = store.zip;
      console.log(firstName, lastName, street, city, state, zip);
      return { firstName, lastName, street, city, state, zip };
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        ...
        createBaseVNode("fieldset", null, [
          ...
          withDirectives(createBaseVNode("input", {
            type: "text",
            id: "firstName",
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(store).firstName = $event),
            required: ""
          }, null, 512), [
            [vModelText, unref(store).firstName]
          ]),
          withDirectives(createBaseVNode("input", {
            type: "text",
            id: "lastName",
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(store).lastName = $event),
            required: ""
          }, null, 512), [
            [vModelText, unref(store).lastName]
          ]),
          _hoisted_4,
          _hoisted_5,
          withDirectives(createBaseVNode("input", {
            type: "text",
            id: "street",
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(store).street = $event)
          }, null, 512), [
            [vModelText, unref(store).street]
          ]),
          withDirectives(createBaseVNode("input", {
            type: "text",
            id: "city",
          ...
          withDirectives(createBaseVNode("input", {
            type: "text",
            id: "zip",
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => unref(store).zip = $event),
            required: ""
          }, null, 512), [
            [vModelText, unref(store).zip]
          ]),
