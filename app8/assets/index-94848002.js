...
const _hoisted_15 = { class: "form-floating mb-2" };
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("h4", null, "Profile Picture Preview: ", -1);
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("img", { id: "preview-img" }, null, -1);
const _sfc_main = {
  __name: "App",
  setup(__props) {
    ...
    watch(phone, () => {
      ...
      phoneErrorRef.value.innerHTML = validPhone.value ? "&nbsp;" : "Not a valid phone number";
    });
    watch(email, () => {
      console.log("email changed");
      validEmail.value = validate(email.value);
      phoneErrorRef.value.innerHTML = validEmail.value ? "&nbsp;" : "Not a valid email address";
    });
        ...
        createBaseVNode("form", _hoisted_2, [
          createBaseVNode("fieldset", _hoisted_3, [
            ...
            createBaseVNode("div", _hoisted_13, [
              _hoisted_14,
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => phone.value = $event),
                id: "phone",
                type: "phone",
                class: "form-control"
              }, null, 512), [
            ...
            createBaseVNode("div", _hoisted_15, [
              ...
              createBaseVNode("input", {
                onChange: [
                  _cache[5] || (_cache[5] = (...args) => unref(profilePic) && unref(profilePic)(...args)),
                  loadPreviewImg
                ],
                id: "profilePic",
                type: "file",
